...
export const PlayerRegistrationPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrorMessage('Erro ao salvar atleta no banco de dados. Tente novamente.');
        ...
        <form className="flex flex-col space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="w-24 h-24 rounded-full bg-slate-100 border-2 border-slate-200 flex flex-col items-center justify-center text-slate-600 relative shadow-inner overflow-hidden">
                {preview || photoUrl ? (
                  ...
                  <div className="flex flex-col items-center justify-center">
                    <span className="material-symbols-outlined text-[32px] text-slate-900 mb-1">add_a_photo</span>
          ...
          <div className="bg-white rounded-2xl p-4 border border-slate-200 shadow-sm space-y-2">
            ...
            <div className="relative flex items-center">
              <span className="material-symbols-outlined absolute left-3 text-slate-900 text-[20px]">
                shield
              </span>
              <select
                value={selectedTeamId}
                onChange={(e) => setSelectedTeamId(e.target.value)}
                className="w-full pl-10 pr-8 py-3 rounded-xl bg-slate-50 text-slate-900 font-bold text-sm focus:outline-none focus:border-slate-900 border border-slate-200 appearance-none transition-colors"
              >
          ...
          <div className="bg-white rounded-2xl p-4 border border-slate-200 shadow-sm space-y-4">
            ...
            <div className="flex flex-col space-y-1">
              ...
              <div className="relative flex items-center">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-3 py-2.5 rounded-xl bg-slate-50 text-slate-900 font-bold text-sm focus:outline-none focus:border-slate-900 border border-slate-200 transition-colors"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-5 gap-3">
              <div className="col-span-2 flex flex-col space-y-1">
                ...
                <div className="relative flex items-center">
                  <span className="material-symbols-outlined absolute left-3 text-slate-900 text-[18px]">
                    pin
                  </span>
                  <input
                    type="number"
                    ...
                    className="w-full pl-9 pr-2 py-2.5 rounded-xl bg-slate-50 text-slate-900 font-bold text-sm focus:outline-none focus:border-slate-900 border border-slate-200"
                  />
                </div>
              </div>
              ...
              <div className="col-span-3 flex flex-col space-y-1">
                ...
                <div className="relative flex items-center">
                  <select
                    ...
                    className="w-full pl-3 pr-8 py-2.5 rounded-xl bg-slate-50 text-slate-900 font-bold text-xs focus:outline-none focus:border-slate-900 border border-slate-200 appearance-none"
                  >
          ...
          >
            ...
            {isSubmitting ? 'Salvando...' : 'Salvar e Cadastrar Atleta'}
          </button>
        </form>
      </div>
    </main>
